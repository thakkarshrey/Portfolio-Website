  ...
  const projectsArr = [
    {
      ...
      name: 'Wizer',
      description:
        'Wizer is an interactive platform for creating personalized digital worksheets and learning materials. It allows educators to design engaging, multimedia-rich content to enhance the learning experience. I Designed and implemented a multi-step authentication workflow, developed interactive puzzle-based worksheets with JavaScript, integrated audio/video recording for multimedia interaction, and enhanced the text editor with canvas-based shape manipulation for creative customization.',
