    ...
    const experienceArr: ExperienceTypes[] = [
        {
            ...
            content: "Developed interactive features like form builders, Kanban boards, and real-time chat for healthcare, education, and business platforms. Led teams, built projects from scratch, and delivered over 200 screens quickly with smooth backend integrations.",
        ...
        },
        {
            ...
            content: "Delivered scalable solutions for real estate, logistics, and navy platforms, specializing in ReactJS development, reusable modules, and seamless front-end transitions. Led key modules like Estates, Orders, and Notifications, enhancing user experience and functionality.",
        ...
        },
        {
            ...
            content: "Streamlined data management for a civil construction company by building efficient modules for items, customers, and suppliers. Enhanced user workflows with form validations, file attachments, and export-to - Excel functionalities using React and modern libraries.",
                    ...
                    <div className="timeline-container">
                        <div className="timeline-container__line"></div>
                        {
                            experienceArr?.map((element: ExperienceTypes, index: number) => {
                                return (
                                    <Timeline key={element.id} {...element} index={index} />
                                )
                            })
                        }
                    </div>
...
const Timeline = ({ company_logo, company_name, start_year, end_year, job_title, content, index }: TimelineProps) => {
    return (
